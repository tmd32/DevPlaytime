...
public static class Localization
{
    ...
    public static string NormalizeLanguage(string? language) =>
        language?.Trim().StartsWith(English, StringComparison.OrdinalIgnoreCase) == true ? English : Korean;
    ...
    private static readonly Dictionary<string, LocalizedText> Strings = new(StringComparer.Ordinal)
    {
        ...
        ["Static.LocalOnly"] = new("로컬 전용  ·  v0.4", "LOCAL ONLY  ·  v0.4"),
        ...
        ["Editor.ExampleProcess"] = new("예: blender", "Example: blender"),
